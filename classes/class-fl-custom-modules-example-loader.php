...
class FL_Custom_Modules_Example_Loader {
	...
	static public function load_modules() {
		...
		require_once FL_MODULE_EXAMPLES_DIR . 'modules/custom-testimonial-slider/custom-testimonial-slider.php';
		require_once FL_MODULE_EXAMPLES_DIR . 'modules/custom-store-locator/custom-store-locator.php';
		require_once FL_MODULE_EXAMPLES_DIR . 'modules/custom-map/custom-map.php';
		require_once FL_MODULE_EXAMPLES_DIR . 'modules/custom-classes-tab/custom-classes-tab.php';
	}
